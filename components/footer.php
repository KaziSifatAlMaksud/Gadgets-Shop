...
<section class="footer">
   ...
   <div class="grid">
      ...
      <div class="box1">
         ...
         <li><a href="home.php" class="links"> <i class="fas fa-arrow-right"></i> home </a></li>
         <li><a href="menu.php" class="links"> <i class="fas fa-arrow-right"></i> menu </a></li>
         <li><a href="orders.php" class="links"> <i class="fas fa-arrow-right"></i> order </a></li>
         <li><a href="about" class="links"> <i class="fas fa-arrow-right"></i> about </a></li>
      </div>
